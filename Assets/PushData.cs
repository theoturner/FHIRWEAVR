...
public class PushData
{
    ...
    // Is there a better way to force threading of all methods in this class than to use Upload as abtraction for UploadCore? *******************
    ...
    public bool FileExistsAtURL(string url)
    {
        ...
        // Does this work? Probably: https://stackoverflow.com/questions/1314155/returning-a-value-from-thread *************************
